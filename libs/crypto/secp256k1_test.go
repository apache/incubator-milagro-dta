...
const (
	...
	testCipherText = "16751918cf55801daf36e6e6e595a41f3e31d7ba2db55790693e90dfff61ba617fa5ad63fb5fd0c52ccf4b2a85c1f527"
...
func TestDecrypt(t *testing.T) {
	...
	plainText, err := Secp256k1Decrypt(testCipherText, testV, testT, secpPrivateKey)
	if err != nil {
		t.Fatal(err)
	}
